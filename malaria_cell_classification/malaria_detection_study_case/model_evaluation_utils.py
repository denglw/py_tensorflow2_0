...
# @File    : model_evaluation_utils.py
# @desc: tensorflow2 深度学习检测疟疾

# 数据地址 https://lhncbc.nlm.nih.gov/publication/pub9932
# 博客地址 https://blog.csdn.net/weixin_34290631/article/details/91405937
# 源码参考 https://opensource.com/article/19/4/detecting-malaria-deep-learning
